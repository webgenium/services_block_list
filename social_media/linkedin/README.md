...
Pasta de bloqueio para **LinkedIn**, contendo domínios, IPs, URLs e ASNs para uso em firewalls.

## Resumo da coleta

| Arquivo | Entradas | Descrição |
|---|---|---|
| `domains.txt` | 17 | Domínios e subdomínios conhecidos |
...
Os domínios de plataforma são de serviços de terceiros utilizados pelo LinkedIn. As URLs específicas para bloqueio não foram encontradas em fontes confiáveis que não fossem domínios já listados. Os IPs listados são blocos CIDR e IPs de amostra de CDNs.
